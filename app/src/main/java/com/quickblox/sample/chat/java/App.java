...
public class App extends Application {
    ...
    //App credentials
    private static final String APPLICATION_ID = "81004";
    private static final String AUTH_KEY = "j5CnvgcKh-536Zd";
    private static final String AUTH_SECRET = "JgHZFbscYnMQAsQ";
    private static final String ACCOUNT_KEY = "x-Cv77Dd6RL7zxMt8FAL";
